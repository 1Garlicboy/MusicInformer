...
if __name__ == '__main__':
    encoded = encode_midi('/home/sh/garlicboy/MusicTransformer-Pytorch-master/informer/rand_100.mid')
    print(encoded)
    print(len(encoded))
    # print(encoded[0])
    # print(encoded[1])
    ...
    # ins = pretty_midi.PrettyMIDI('/home/sh/garlicboy/MusicTransformer-Pytorch-master/dataset/maestro-v2.0.0/2004/MIDI-Unprocessed_SMF_02_R1_2004_01-05_ORIG_MID--AUDIO_02_R1_2004_05_Track05_wav.midi')
    # print(ins)
