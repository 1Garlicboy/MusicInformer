...
def parse_generate_args():
    ...
    # parser.add_argument("-primer_file", type=str, default='/home/sh/garlicboy/MusicTransformer-Pytorch-master/dataset/maestro-v2.0.0/2004/MIDI-Unprocessed_SMF_02_R1_2004_01-05_ORIG_MID--AUDIO_02_R1_2004_05_Track05_wav.midi', help="File path or integer index to the evaluation dataset. Default is to select a random index.")
    # parser.add_argument("-primer_file", type=str, default='/home/sh/garlicboy/MusicTransformer-Pytorch-master/dataset/maestro-v2.0.0/2018/MIDI-Unprocessed_Chamber1_MID--AUDIO_07_R3_2018_wav--2.midi', help="File path or integer index to the evaluation dataset. Default is to select a random index.")
    # parser.add_argument("-primer_file", type=str, default='/home/sh/garlicboy/MusicTransformer-Pytorch-master/dataset/maestro-v2.0.0/2017/MIDI-Unprocessed_041_PIANO041_MID--AUDIO-split_07-06-17_Piano-e_1-01_wav--1.midi', help="File path or integer index to the evaluation dataset. Default is to select a random index.")
    # parser.add_argument("-primer_file", type=str, default='/home/sh/garlicboy/MusicTransformer-Pytorch-master/dataset/maestro-v2.0.0/2015/MIDI-Unprocessed_R1_D1-1-8_mid--AUDIO-from_mp3_01_R1_2015_wav--1.midi', help="File path or integer index to the evaluation dataset. Default is to select a random index.")
    
    parser.add_argument("-primer_file", type=str, help="File path or integer index to the evaluation dataset. Default is to select a random index.")
    parser.add_argument("--force_cpu", action="store_true", help="Forces model to run on a cpu even when gpu is available")
    ...
    parser.add_argument("-model_weights", type=str, default="./rpr3/results/best_loss_weights.pickle", help="Pickled model weights file saved with torch.save and model.state_dict()")
